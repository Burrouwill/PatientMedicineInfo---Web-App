...
public class Drug {
    ...
    public enum DrugClass {
        ...
        BRONCHODILATOR("Used to relieve asthma symptoms."),
        ...
        LIPID_LOWERING("Used to control cholesterol levels."),
        MUSCLE_RELAXANT("Used to relax muscles."),
        NSAID("Nonsteroidal anti-inflammatory drugs used for pain and inflammation."),
        PROSTATE("Used to manage problems with prostate."),
        PROTON_PUMP_INHIBITOR("Helps to control stomach acid."),
